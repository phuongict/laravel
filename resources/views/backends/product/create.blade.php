                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="product_description" id="product_description" rows="5" placeholder="{{ __('product.product_description') }}"
                                      class="form-control textarea @error('product_description') is-invalid @enderror">{{ old('product_description') }}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea name="product_info" id="product_info" placeholder="{{ __('product.product_info') }}"
                                      class="form-control @error('product_info') is-invalid @enderror">{{ old('product_info') }}</textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="unit_id" id="unit_id" class="form-control select2" data-placeholder="{{ __('product.choose_unit') }}">
                                ...
                                @foreach($listUnit as $unit)
                                    <option value="{{ $unit->id }}" @if(old('unit_id') && $unit->id == old('unit_id')) selected @endif>{{ $unit->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <span class="text-danger" id="price_real">{{ old('price') && old('discount')? old('price') - (old('price')*old('discount')):'' }}</span>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="product_category_id" id="product_category_id" class="form-control select2" data-placeholder="{{ __('product.choose_category') }}">
                                ...
                                @foreach($listCategory as $category)
                                    <option value="{{ $category->id }}" @if(old('product_category_id') && $category->id == old('product_category_id')) selected @endif>{{ $category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
