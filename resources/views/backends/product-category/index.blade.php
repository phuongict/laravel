                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12 text-center">
                        <div class="form-group">
                            ...
                            <a class="btn btn-info btn-sm" href="{{  route('backend.product-category.create') }}"> {{ __('all.add_new') }}</a>
                        </div>
                    </div>
                </div>
            </form>
                    ...
                    @if(isset($lists) && $lists->count() > 0)
                        @foreach($lists as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('backend.product-category.edit', ['id' => $item->id]) }}"><i class="fa fa-edit"></i></a>
                                    <a href="{{ route('backend.product-category.delete', ['id' => $item->id]) }}"><i class="fa fa-trash" style="color: red;"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    @endif
